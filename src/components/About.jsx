          ...
          {Track.map((data, index) => (
            ...
            >
              <div className="flex flex-col items-center justify-center  p-4 rounded-lg shadow-md">
                ...
                <span className="text-xl font-semibold text-white font-[Poppins] text-[28px]">
                  {data.text}
                </span>
        ...
        <span className="w-[634px] font-[Poppins] font-medium text-[25px] leading-[31.45px] text-white  text-start mr-24">
          <motion.div variants={textVariant()}>
            ...
            <span className="font-[Poppins]">
              ...
              , a thrilling 36-hour hackathon <br /> inspired by the
              electrifying theme of Squid Game!
              <br />
              <pre className="mt-2 w-[634px] font-[Poppins] font-medium text-[25px] leading-[31.45px] text-white  text-start ">
                Organized by{" "}
                <span className="font-extrabold">{"Code</>Geeks"}</span> , the
                premier coding <br />
                society of Guru Tegh Bahadur 4th Centenary <br />
                Engineering College, this unique hackathon will <br />
                take place on 28th February and 1st March 2025.
              </pre>
            </span>
          </motion.div>
        </span>
