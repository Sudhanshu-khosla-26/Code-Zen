...
const Audio = () => {
    const audioRef = useRef(new window.Audio("squidaudio.mp3"));
    ...
    return (
        <div>
            <button className='z-50 text-white fixed border-2 p-2 border-white rounded-full  right-[6vw] top-[80vh]' onClick={playAudio}>

                {/* {isPlaying ? 'Pause' : 'Play'} */}
                {/* </button> */}
                {/* <button aria-label="Turn audio on" className="z-50 text-white fixed right-[8vw] top-[80vh] color-supplementary hasIcon round ltr-11vo9g5" data-uia="audio-toggle-muted" type="button"> */}
                {/* <div className="ltr-1st24vv"><div className="small ltr-iyulz3" role="presentation"> */}
                {isPlaying ?
